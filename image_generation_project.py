...
openai.api_key = "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"
...
def save_image(image, path):
    while os.path.isfile(path):
        ...
        new_image = image_name + str(random.randint(1, 1_000_000))

        path = path.replace(image_name, new_image)
...
input_field.place(x=180, y=20)

button_generator = tk.Button(window, text="Create", height=1, command=render_image)
button_generator.place(x=300, y=17)
